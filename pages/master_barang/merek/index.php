...
if (isset($_POST['submit'])) {
    $nama = $_POST['nama'];
    mysqli_query($conn, "INSERT INTO merek (nama) VALUES ('$nama')");
}
$query = mysqli_query($conn, "SELECT * FROM merek");
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="index.php?merek=update&id=<?= $data['id']; ?>" class="btn btn-sm btn-warning">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <a href="index.php?merek=delete&id=<?= $data['id']; ?>" onclick="confirmDelete(event)" class="btn btn-sm btn-danger" id="delete-alert">
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header ">
                <p class="modal-title fw-bold">Form Master Data Merek</p>
            ...
            <div class="modal-body">
                <form action="" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control" id="merek" placeholder="Nama Merek">
                    </div>
                    <div class="clearfix">
