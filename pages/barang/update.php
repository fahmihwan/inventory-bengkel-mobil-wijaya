                ...
                <div class="card-body px-4">
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="merek_id" class="js-example-basic-single-merek form-control rounded-pill border-none py-2" style=" box-shadow: rgba(17, 17, 26, 0.1) 0px 1px 0px;">
                                <?php if ($fetchBarang['merek']) { ?>
                                    <option selected value="<?= $fetchBarang['merek_id'] ?>"><?= $fetchBarang['merek'] ?></option>
                                <?php } ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="rak_id" class="js-example-basic-single-rak form-control rounded-pill border-none py-2" style=" box-shadow: rgba(17, 17, 26, 0.1) 0px 1px 0px;">
                                ...
                                <?php } ?>
                                <?php while ($fetch_rak = mysqli_fetch_assoc($kategori)) : ?>
